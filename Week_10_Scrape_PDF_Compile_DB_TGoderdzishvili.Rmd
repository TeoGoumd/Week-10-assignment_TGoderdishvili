...
text <- pdf_text("D:/A DATA CLASS 2/exercises/spooky/AIW.PDF")
#pdf_text reads the text from a PDF file.
writeLines(text, "D:/A DATA CLASS 2/exercises/spooky/AIW.txt")
#writeLines writes this text to a text file
```
D:/A DATA CLASS 2/exercises/spooky
...
file_path <- "D:/A DATA CLASS 2/exercises/spooky/AIW.txt"
...
output_dir <- "D:/A DATA CLASS 2/exercises/spooky/extracted"
for (i in seq_along(documents)) {
  output_file <- file.path(output_dir, paste0("AIW_extracted_", i, ".txt"))
...
```{r}
AIW_index <- read_lines("D:/A DATA CLASS 2/exercises/spooky/extracted/AIW_extracted_1.txt")


# Extract lines 16 to 91
extracted_lines <- AIW_index[16:91]
...
D:/A DATA CLASS 2/exercises/spooky/extracted/AIW_extracted_1.txt
...
write_csv(final_data, "D:/A DATA CLASS 2/exercises/spooky/extracted.csv")
...
files <- list.files("D:/A DATA CLASS 2/exercises/spooky/extracted", pattern="*.txt") %>% 
  as.data.frame() |> 
  rename(filename = 1) |> 
...
#the actual path: #D:/A DATA CLASS 2/exercises/spooky/extracted

#Join the file list to the index

#load final data if you haven't already
#final_data <- read.csv("D:/A DATA CLASS 2/exercises/spooky/final_data.csv")

final_index <- final_data |> 
  inner_join(files, c("index")) |> 
#you need the actual hard-coded path on this line below to the text
  
  # mutate(filepath = paste0("D:/A DATA CLASS 2/exercises/spooky/extracted", filename))
  mutate(filepath = paste0("D:/A DATA CLASS 2/exercises/spooky/extracted", filename))
head(final_index)
```
...
#write.csv(articles_df, "D:/A DATA CLASS 2/exercises/spooky/extracted")
